...
/**
 * Versão do componente Navigation que é garantidamente segura para SSR
 * Substitui completamente a necessidade de useLocation
 */
const ClientNavigation = () => {
  const router = useRouter();
  const { t } = useLanguage();
  
  // Verificar qual rota está ativa usando o router do Next.js

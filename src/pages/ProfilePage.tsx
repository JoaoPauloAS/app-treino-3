      ...
      <div className="fitness-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div className="fitness-card p-4 flex flex-col items-center">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">{t("total_volume")}</p>
            <p className="text-xl font-bold">87,450 kg</p>
          </div>
          
          <div className="fitness-card p-4 flex flex-col items-center">
            <Clock className="h-8 w-8 text-fitness-purple mb-2" />
            <p className="text-sm text-gray-600 dark:text-gray-300">{t("workout_time")}</p>
            <p className="text-xl font-bold">42 hours</p>
          </div>
          
          <div className="fitness-card p-4 flex flex-col items-center">
            <Medal className="h-8 w-8 text-fitness-purple mb-2" />
            <p className="text-sm text-gray-600 dark:text-gray-300">{t("total_workouts")}</p>
          ...
          <div className="fitness-card">
            <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
              <div className="flex items-center">
                ...
                <p className="font-medium">{t("profile_information")}</p>
              </div>
